defmodule ElixirOCTest do
  ...
  test "worker bus routes" do
    assert ElixirOC.Worker.route_summary(7687) == %{1 => "South Keys", 7 => "Carleton", 11 => "Bayshore"}
  ...
  test "main process" do
    ...
    assert ElixirOC.bus_routes_list([7687, {7659, 1}]) == %{7659 => %{1 => "Ottawa-Rockcliffe"}, 7687 => %{1 => "South Keys", 7 => "Carleton", 11 => "Bayshore"}} 
  end
end
